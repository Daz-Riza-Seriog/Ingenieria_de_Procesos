...
class set_initial_state_flux_drop_jacket_recicle:
    __metaclass__ = Reactor
    x_0 = np.empty(10)  # allocate memory
    x_0[0] = Reactor.F_A0  # molar flow rate of AO
    x_0[1] = Reactor.F_H0 + 0.0923443628355057  # molar flow rate of H2
    x_0[2] = 9.87656583903788E-12  # molar flow rate of B
    x_0[3] = 1.0103397934513E-07  # molar flow rate of C
    x_0[4] = 2.11108795254679E-12  # molar flow rate of D    
    x_0[5] = 0.00196191113948828  # molar flow rate of E
    x_0[6] = 0.0440562404139517  # molar flow rate of CO
    x_0[7] = 29.99999136356647 # pressure
    x_0[8] = 573.0979190943611 # Temperature
    x_0[9] = Reactor.Ta_0
